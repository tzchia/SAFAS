import cv2, PIL, glob, os, pickle, re, ffmpeg, math
...
def preprocess_imglist(imglist, savepath):
...
def run_celeba(rootpath):
    outpath = os.path.join(rootpath, "preprocess")
    os.makedirs(outpath, exist_ok=True)
        ...
        for id in os.listdir(path_split):
            ...
            for live_or_spoof in ["live", "spoof"]:
                ...
                if os.path.exists(path_split_id_label):
                    ...
                    preprocess_imglist(img_file_list, savepath)
